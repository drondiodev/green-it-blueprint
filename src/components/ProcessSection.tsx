    ...
    <section className="py-20 bg-secondary/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          {/* Connection lines */}
          <div className="hidden md:block absolute top-20 left-1/2 transform -translate-x-1/2 w-full h-0.5 bg-gradient-primary opacity-30 z-0"></div>
          
          {steps.map((step, index) => (
            <Card key={index} className="relative z-10 hover:shadow-strong transition-all duration-300 border-primary/20">
